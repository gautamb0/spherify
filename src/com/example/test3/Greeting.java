...
public class Greeting {
   ...
   **/
  public Greeting(String book, String blob_key) {
    this();
    if( book != null ) {
  ...
  public Greeting(String book, String blob_key, String url) {
	    this(book, blob_key);
	    perma_url = url;
	  }
   ...
   **/
  public Greeting(String book, String blob_key, String url, String id, String email) {
